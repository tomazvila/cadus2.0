...
Gate on `main` at `99d2901` after the fix wave: `npm run check` PASS (CSP audit clean), Rust gate 1,800 tests, 0 failed (log gate-m6-2). Verification round `wf_49d536f8-225` runs next.
