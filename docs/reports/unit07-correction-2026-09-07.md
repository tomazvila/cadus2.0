...
- Against integration `d4be3956`, whole-course duplicate KPs are **45 → 36** and all other audit codes are non-regressing.
...
|---|---:|---:|---:|
| `fewer_than_four_exemplars` | 412 | 328 | 0 |
| `missing_solution_sketch` | 230 | 170 | 0 |
| `undecidable_authored_answer` | 95 | 92 | 0 |
| `singleton_label_contract` | 0 | 0 | 0 |
| `duplicate_problem_answer_family` | 45 | 36 | 0 |
| `absent_pending_template_recipe` | 490 | 427 | 28 |
| `generic_or_tautological_sketch` | 4 | 4 | 0 |

The final whole-course audit has 428 issue KPs; unit07 has only its 28 explicitly blocked pending-template recipes. Its exit status is 1 because these residuals remain. See [the complete live audit](unit07-audit.json) and [machine-readable summary and digests](unit07-summary.json).
