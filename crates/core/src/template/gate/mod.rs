...
use crate::curriculum::{AnswerKind, Exemplar, FiniteObjectiveDomain};
...
/// A reviewed finite-universe template policy bound to a knowledge point.
#[derive(Debug, Clone)]
...
impl<'kp> GateSpec<'kp> {
    ...
    #[must_use]
    pub fn new(answer_kind: AnswerKind, exemplars: &'kp [Exemplar]) -> Self {
        Self {
            answer_kind,
            exemplars,
            finite: None,
