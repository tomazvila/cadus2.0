...
const OPEN_RESIDUALS: &[&str] = &[
    "division-with-remainders/kp3",
    "long-division-one-digit/kp1",
    "long-division-one-digit/kp2",
    "long-division/kp1",
    "long-division/kp2",
    "multiplication-division-word-problems/kp1",
    "multiplication-division-word-problems/kp2",
    "multiplication-division-word-problems/kp3",
    "whole-number-exponents/kp1",
    "whole-number-exponents/kp2",
    "whole-number-exponents/kp3",
    "expressions-with-parentheses/kp1",
    "expressions-with-parentheses/kp2",
    "expressions-with-parentheses/kp3",
    "order-of-operations/kp1",
    "order-of-operations/kp2",
    "order-of-operations/kp3",
    "factors-and-multiples/kp1",
    ...
    "prime-composite-numbers/kp2",
    "prime-composite-numbers/kp3",
    "prime-factorization/kp1",
    "prime-factorization/kp2",
    "prime-factorization/kp3",
    "greatest-common-factor/kp1",
    "greatest-common-factor/kp2",
    "greatest-common-factor/kp3",
    "least-common-multiple/kp1",
    "least-common-multiple/kp2",
    "least-common-multiple/kp3",
    "gcf-lcm/kp1",
    "gcf-lcm/kp2",
    "gcf-lcm/kp3",
    "rounding-estimation/kp1",
    "rounding-estimation/kp2",
    "rounding-estimation/kp3",
];
